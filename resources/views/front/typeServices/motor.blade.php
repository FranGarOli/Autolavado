...
@section('cuerpo')
    <main class=" d-flex flex-column gap-5 text-center mt-5">
        ...
        <p>La limpieza de motor se efectúa con producto dispersante de grasas y aceite, no vasados en disolventes y con
            ...
            se limpiara en alta presión con agua osmotizada, terminando con el secado y con la aplicación de un producto
            para nutrir gomas y manguitos
            NOTA- Al tratarse de una limpieza en partes eléctricas ocasionalmente puede haber un riesgo de fallos de
            motor o derivaciones.Por lo tanto nosotros no nos responsabilizaremos de estos posibles fallos que pudieran
